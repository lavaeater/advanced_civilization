...
impl ButtonDef {
    ...
    pub fn get_text_font(&self) -> TextFont {
        TextFont::default().with_font(self.font.clone()).with_font_size(self.font_size)
    }
...
impl UiBuilderDefaults {
    ...
    pub fn get_btn_text_bundle(&self, input: Option<ButtonPartial>) -> (Text, TextFont, TextColor) {
...
impl<'w, 's> UIBuilder<'w, 's> {
    ...
    pub fn with_text(
        ...
        let text_bundle = (
            Text::new(text.into()),
            TextFont::default().with_font(font.unwrap_or(self.defaults.base_font.clone()))
